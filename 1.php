    ...
    <body>
        ...
        <div class="mui-content">
            <div class="mui-content-padded" style="margin: 5px;">
                    <form action="2.php" class="mui-input-group" method="post" autocomplete="off">
                    ...
                    <div class="mui-input-row">
                         <label>商户号:</label>
                        <input type="text" name="appid" class="mui-input" value="8y0ocEOIqKwCj1Sz" >
                    </div>
                    <div class="mui-input-row">
                         <label>商户密钥:</label>
                        <input type="text" name="key" class="mui-input" placeholder="" value="22fdc426e1b68061a520309363b434c8" style="font-size: 1rem;">
                    </div>
                    <br>
