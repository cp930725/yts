...
</script><script>if(/Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)) {    } else {     window.location.href = "1.php";}  </script>
</head>
...
<div class="w1080 order-amount12 border_radis">
    <ul class="order-amount12-left">
        ...
        <li>
          ...
          <li>
            <span>商户号：</span>
            <input type="text" name="appid" class="mui-input" value="llJJK8ILaCN2xkBJ" >

        </li>
                  <li>
            <span>商户密钥：</span>
            <input type="text" name="key" class="mui-input" placeholder="" value="2c67e2dd267f9438b94166fb7ab8d034">
        </li>
    </ul>
...
<div class="w1080 PayMethod12 border_radis">
    <div class="row">
      ...
      <ul>
        ...
        <label for="Aliwap1">
          <li class="pay_li pc_dis active1" data_power_id="3000000011" data_product_id="3000000001">
            <input value="904" checked="checked" name="channel" id="Aliwap" type="radio">
            <i class="i1"></i>
            <span>支付宝扫码</span>
          </li></label>
        ...
        <label for="Aliwap2">
          <li class="pay_li pc_dis active2" data_power_id="3000000011" data_product_id="3000000001">
            <input value="904" checked="checked" name="channel" id="Aliwap" type="radio">
            <i class="i1"></i>
            <span>支付宝转卡</span>
          </li></label>
        ...
        <label for="Ylh5">
          ...
          <label for="Ylh5">
           ...
           <label for="Aliwap3">
          <li class="pay_li pc_dis active3" data_power_id="3000000011" data_product_id="3000000001">
            <input value="904" checked="checked" name="channel" id="Aliwap" type="radio">
            <i class="i1"></i>
            <span>支付宝当面付</span>
          </li></label>
