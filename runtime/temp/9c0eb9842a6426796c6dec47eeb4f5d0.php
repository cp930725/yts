<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/www/wwwroot/abc.yptsc.cn/public/../application/admin/view/merchant/rechargelist.html";i:315504000;s:67:"/www/wwwroot/abc.yptsc.cn/application/admin/view/public/header.html";i:1563934900;s:67:"/www/wwwroot/abc.yptsc.cn/application/admin/view/public/footer.html";i:1563934900;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                ...
                <!-- <div  class="col-sm-2" style="width: 100px">
                    ...
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('rechargelist'); ?>">
                        <div class="col-sm-6">
                            <div class="input-group">
                                ...
                                <select name="status" class="form-control" id="status" style="width:33%;">
                                	...
                                	<option value="1" <?php if($status == '1'): ?>selected<?php endif; ?>>生成充值订单</option>
                                	<option value="2" <?php if($status == '2'): ?>selected<?php endif; ?>>已收款</option>
                                </select>
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.getJSON('<?php echo url("Merchant/rechargelist"); ?>', {page: curr || 1,key:key, keyuser:keyuser, status:status}, function(data){
