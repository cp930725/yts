...
<div class="content-wrapper" id="pjax-container" style="min-height: 414px;">
   ...
   @media (max-width: 768px){
                    ...
                    <div class="box-body config-forms">
                        <form action="/merchant/merchantSet" method="post" class="form-horizontal" autocomplete="off">
                            <div class="form-group">
                                <label class="col-md-2 control-label">USDT充值
                                    <?php 
    ...
    color: #4f94e7;
    padding: 20px;"><?php echo $qianbao; ?></p>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-6 control-label" style="text-align:left;">
                                    转入说明：<br />
                                    1. 转入是自动的， USDT资产 转账需要整个 USDT资产 网络进行确认，达到 <?php echo $confirms; ?> 个确认后您的 USDT资产 会自动充值到您的账户中<br />
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    转入成功
                                                    <?php else: ?>
                                                    等待处理,还需要<?php echo $confirms-$vo['confirmations']; ?>个确认
                                                    <?php endif; ?>
                                                </td>
                                                <td><a href="javascript:;" onclick="showtxid('<?php echo $vo['txid']; ?>')" class="btn btn-primary btn-xs">
                                        查看TXID</a></td>
                                            </tr>
