...
<div class="content-wrapper" id="pjax-container" style="min-height: 706px;">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <div class="btn-group pull-right" style="margin-right: 10px">
                                ...
                                <a href="/merchant/tibi" class="btn btn-sm btn-facebook"><i class="fa fa-undo"></i>&nbsp;&nbsp;重置</a>
                            </div>
                            <div class="modal fade" id="filter-modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="/merchant/tibi" method="get" pjax-container="">
                                                ...
                                                <div class="form">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <label>提现USDT</label>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="提现USDT" name="buy_amount[start]" value=""><span class="input-group-addon" style="border-left: 0; border-right: 0;">-</span>
                                                                <input type="text" class="form-control" placeholder="提现USDT" name="buy_amount[end]" value="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="btn-group pull-right" style="margin-right: 10px">
                                <a class="btn btn-sm btn-twitter" href='<?php echo url("home/merchant/outTiBi"); ?>' target="_blank"><i class="fa fa-download"></i> 导出</a>
                            </div>
                            &nbsp;&nbsp;
                            <div class="btn-group pull-right" style="margin-right: 10px">
                                <a href="/merchant/addTiBi" class="btn btn-sm btn-success">
                                    <i class="fa fa-save"></i>&nbsp;&nbsp;新增提币
                                </a>
                            </div>
                        </div>
                        <span>
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <tbody>
                                <tr>
                                    <th>ID<a class="fa fa-fw fa-sort" href="/merchant/tibi?order=asc"></a>
                                    </th>
                                    <th>订单号</th>
                                    <th>提币USDT</th>
                                    <th>转出地址</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php switch($vo['status']): case "0": ?><button type="button" class="btn btn-primary" data-id="<?php echo $vo['id']; ?>" onclick="cancel(this)">撤销</button><?php break; case "3": ?>无操作<?php break; case "2": ?>无操作<?php break; case "1": 
                                            ...
                                            if(config('wallettype')=='erc'){
                                             ...
                                             ?>
                                            <a href="<?php echo $url; ?><?php echo $vo['txid']; ?>" target="_blank" class="btn btn-sm btn-success">查看TXID</a><?php break; endswitch; ?>
    ...
    function cancel(obj) {
        layer.confirm('确认撤销吗？', { btn: ['确定', '取消'], title: "提示" }, function() {
            var id = $(obj).attr('data-id');
            if (id == null || id == undefined || id == '') {
                layer.msg('参数错误', { icon: 2 });
            }
            var url = '/home/merchant/cancel';
            $.ajax({
                type: "post",
                url: url,
                data: { id: id },
