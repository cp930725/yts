                            ...
                            <div class="modal fade" id="filter-modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="/merchant/downmerchant" method="get" pjax-container="">
                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!--<td><?php echo $vo['merchant_tibi_fee']; ?></td>
                                    <td><?php echo $vo['user_withdraw_fee']; ?></td>
                                    <td><?php echo $vo['user_recharge_fee']; ?></td>-->
                                    <td><?php echo date("Y-m-d H:i:s", $vo['addtime']); ?></td>
                                    <td>
                                        <?php if($vo['reg_check'] == 0): ?>待审核<?php elseif($vo['reg_check'] == 1): ?>通过<?php elseif($vo['reg_check'] == 2): ?>拒绝<?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if($vo['reg_check'] == '0'): ?>
                                        <a href="/home/merchant/checkdown?id=<?php echo $vo['id']; ?>&type=1" class="btn btn-sm btn-danger">通过</a>
                                        <a href="/home/merchant/checkdown?id=<?php echo $vo['id']; ?>&type=2" class="btn btn-sm btn-success">拒绝</a>
                                        <?php else: ?>
                                        ---
                                        <?php endif; ?>
                                    </td>
                                    <!--<td>
                                        <a href="/merchant/editdown?id=<?php echo $vo['id']; ?>" class="btn btn-sm btn-success">编辑</a>
                                    </td>-->
                                </tr>
