                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <div class="btn-group pull-right" style="margin-right: 10px">
                                <a href="/merchant/adindex" class="btn btn-sm btn-facebook"><i class="fa fa-undo"></i>&nbsp;&nbsp;重置</a>
                            </div>
                            &nbsp;&nbsp;
                        </div>
                        <span>
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <tbody>
                                <tr>
                                    <th>ID<a class="fa fa-fw fa-sort" href="/merchant/adindex?order=asc"></a>
                                    </th>
                                    <th>类型</th>
                                    <th>价格</th>
                                    <th>总量</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <font color='red'>买入</font>
                                    </td>
                                    <td><?php echo $vo['price']; ?></td>
                                    <td><?php echo $vo['amount']; ?></td>
                                    <td><?php echo $vo['remain_num']; ?></td>
                                    <td><?php echo $vo['min_limit']; ?>~<?php echo $vo['max_limit']; ?></td>
                                    <td><?php echo $vo['name']; ?></td>
                                    <!-- <td><?php echo msubstr($vo['name'], 0, 1); ?></td> -->
                                    <td><?php echo $vo['transact_buy']; ?></td>
                                    <td><?php echo round($vo['averge_buy']/60); ?>分钟</td>
                                    <td>
                                        <?php 
                                        if($vo['pay_method']> 0){
                                        echo '<img src="/static/home/images/bank.png" class="w26" />';
                                        }
                                        if($vo['pay_method2']> 0){
                                        echo '<img src="/static/home/images/alipay.png" class="w26" />';
                                        }
                                       if($vo['pay_method3']> 0){
                                        echo '<img src="/static/home/images/wechatpay.png" class="w26" />';
                                        }
                                        if($vo['pay_method4']> 0){
                                        echo '<img src="/static/home/images/yun.png" class="w26" width="32"  height="32" />';
                                        }
                                         ?>
                                    </td>
                                    <td>
                                        <a href="/merchant/addetail?id=<?php echo $vo['id']; ?>" class="btn btn-sm btn-success">卖出</a>
                                    </td>
                                </tr>
