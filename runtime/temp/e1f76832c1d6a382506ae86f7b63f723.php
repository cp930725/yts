...
<div class="content-wrapper" id="pjax-container" style="min-height: 706px;">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <div class="btn-group pull-right" style="margin-right: 10px">
                                <a href="/merchant/newad" class="btn btn-sm btn-success">
                                    <i class="fa fa-save"></i>&nbsp;&nbsp;发布出售广告</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="/merchant/newadbuy" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container="">
                        <div class="box-body">
                            <div class="fields-group">
                                <div class="form-group">
                                    <label for="currency" class="col-sm-3 control-label"><em class="text-danger">*</em> 购买数量：</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="currency" class="col-sm-3 control-label"><em class="text-danger">*</em> 购买价格：</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="currency" class="col-sm-3 control-label"><em class="text-danger">*</em> 付款方式：</label>
                                    <div class="col-sm-9">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/merchant/editadbuy?id=<?php echo $vo['id']; ?>" class="btn btn-sm btn-success">编辑</a>
                                            <?php if($vo['state'] == '1'): ?>
    ...
    $('.down').click(function() {
        ...
        $.post("<?php echo url('home/merchant/setShelfbuy'); ?>", { id: $(this).attr('id'), type: type, act: 2 }, function(data) {
            shelf = data.url;
    ...
    $('.up').click(function() {
        layer.load(0, { shade: [0.5, '#8F8F8F'] });
        $.post("<?php echo url('home/merchant/setShelfbuy'); ?>", { id: $(this).attr('id'), type: type, act: 1 }, function(data) {
            shelf = data.url;
            setTimeout("closetanchu()", 4000);
            if (data.code == 1) {
                layer.msg(data.msg, { icon: 1 });
