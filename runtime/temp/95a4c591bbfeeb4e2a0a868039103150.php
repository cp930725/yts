<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/www/wwwroot/abc.yptsc.cn/public/../application/admin/view/message/index.html";i:1250449438;s:67:"/www/wwwroot/abc.yptsc.cn/application/admin/view/public/header.html";i:1563934900;s:67:"/www/wwwroot/abc.yptsc.cn/application/admin/view/public/footer.html";i:1563934900;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('index'); ?>">
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" id="key" class="form-control" name="key" value="<?php echo $val; ?>" placeholder="输入用户名 或手机号" />
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        var key=$('#key').val();
        $.getJSON('<?php echo url("Message/index"); ?>', {
            page: curr || 1,key:key
...
function edit_ad(id){
    ...
    location.href = './editMessage/id/'+id+'.html';
}
 ...
 */
function del_ad(id){
    layer.confirm('确认删除此问题?', {icon: 3, title:'提示'}, function(index){
        $.getJSON('<?php echo url("delMessage"); ?>', {'id' : id}, function(res){
            if(res.code == 1){
