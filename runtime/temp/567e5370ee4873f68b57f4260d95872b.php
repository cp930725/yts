<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/wwwroot/abc.yptsc.cn/public/../application/home/view/merchant/pay.html";i:1606929221;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div id="container">
		<div id="main">
			<p id="time-p">下单时间：<span><?php echo $ctime; ?></span></p>
			<p id="pay-2-obj">您正在向&nbsp;<span><?php echo $truename; ?></span>&nbsp;购买&nbsp;<span>USDT</span></p>
			<div id="info">
				<p>
					USDT数量
					<span><strong><?php echo $amount; ?></strong></span>
				</p>
				<p>
					汇率
					<span><strong><?php echo $rate; ?></strong></span>
				</p>
				<p>
					支付金额
					<span><strong><?php echo $money; ?></strong>&nbsp;元</span>
				</p>
				<p>
					支付倒计时
				...
				<div class="pay-content">
					<div class="payment-info usdt" style="display:black;">
						...
						<div class="order-info">
							...
							<p style="width:60%;margin: 5px auto 4px;font-size:14px;font-weight:600;text-align: center;" id="usdt-address"><?php echo $usdte; ?></p>
	                        ...
	                        <p style="width:60%;margin:5px auto 1%;font-size:16px;">
	                            请勿向上述地址充值任何非 <span style="color: red; font-size: 18px;"><b>USDT-ERC20</b></span>资产，否则资产将不可找回。您充值至上述地址后，需要整个网络节点的确认，12次网络确认后到账。最小充值金额：1USDT,小于最小金额的充值将不会上账且无法退回。您的充值地址不会经常改变，可以重复充值。请务必确认客户端安全，防止信息被篡改或泄露。
	                        </p>
						</div>
					</div>
					<div class="payment-info bank" style="display:none;">
						...
						<p>
							订单金额：<span><strong id="bank-price"><?php echo $money; ?></strong>元&nbsp;<font data-clipboard-target="#bank-price" id="copy1">复制</font></span>
						</p>
						<p>
							订单号：<span><strong id="bank-no"><?php echo $no; ?></strong>&nbsp;<font data-clipboard-target="#bank-no" id="copy2">复制</font></span>
						</p>
						<div class="order-info">
							<p>
								真实姓名：<span><strong id="bank-name"><?php echo $bank_name; ?></strong>&nbsp;<font data-clipboard-target="#bank-name" id="copy3">复制</font></span>
							</p>
							<p>
								银行卡号：<span><strong id="bank-card"><?php echo $c_bank_card; ?></strong>&nbsp;<font data-clipboard-target="#bank-card" id="copy4">复制</font></span>
							</p>
							<p style="padding-bottom:2%;">
								开户银行：<span><strong id="bank-bankname"><?php echo $bank; ?></strong>&nbsp;<font data-clipboard-target="#bank-bankname" id="copy5">复制</font></span>
							</p>
						</div>
					</div>
					<div class="payment-info zfb" style="display:none;">
						...
						<p>
							订单金额：<span><strong id="zfb-price"><?php echo $money; ?></strong>元&nbsp;<font data-clipboard-target="#zfb-price" id="copy6">复制</font></span>
						</p>
						<p>
							订单号：<span><strong id="zfb-no"><?php echo $no; ?></strong>&nbsp;<font data-clipboard-target="#zfb-no" id="copy7">复制</font></span>
						</p>
						<div class="order-info">
							<p>
								真实姓名：<span><strong id="zfb-name"><?php echo $zfb_name; ?></strong>&nbsp;<font data-clipboard-target="#zfb-name" id="copy8">复制</font></span>
							</p>
							<div class="payment-img">
								<img src="<?php echo $c_alipay_img; ?>">
							</div>
						</div>
					</div>
					<div class="payment-info wx" style="display:none;">
						...
						<p>
							订单金额：<span><strong id="wx-price"><?php echo $money; ?></strong>元&nbsp;<font data-clipboard-target="#wx-price" id="copy9">复制</font></span>
						</p>
						<p>
							订单号：<span><strong id="wx-no"><?php echo $no; ?>&nbsp;</strong><font data-clipboard-target="#wx-no" id="copy10">复制</font></span>
						</p>
						<div class="order-info">
						    <p>
								真实姓名：<span><strong id="zfb-name"><?php echo $wx_name; ?></strong>&nbsp;<font data-clipboard-target="#zfb-name" id="copy8">复制</font></span>
							</p>
							<div class="payment-img">
								<img src="<?php echo $c_wechat_img; ?>">
							</div>
						</div>
					</div>
				</div>
			...
			<p class="remark pay-warn">
				...
				<span style="float: right;">需要向对方支付<span style="color:#36EF9B;"><?php echo $money; ?></span>CNY</span>
			</p>
			<p class="remark">
...
<script type="text/javascript" src="/static/home/js/pay/jquery-2.2.4.min.js"></script>
<script type="text/javascript" src="/static/home/js/pay/jquery.qrcode.min.js"></script>
<script type="text/javascript" src="/static/home/js/pay/clipboard.min.js"></script>
<script type="text/javascript">
	$(function(){
	    var ddNUm = <?php echo $money; ?>;
    ...
    function CheckOutTime(){
        var id = <?php echo (isset($id) && ($id !== '')?$id:0); ?>;
    	$.ajax({
    		url:'<?php echo url("home/merchant/CheckOutTime"); ?>',
    		type:'post',
    		data:{
    			id:id
    		},
    ...
    function uptrade(){
        ...
        var appid = "<?php echo (isset($appid) && ($appid !== '')?$appid:''); ?>";
        var id = <?php echo (isset($id) && ($id !== '')?$id:0); ?>;
        $.ajax({
            url:'<?php echo url("home/merchant/uptrade"); ?>',
            type:'post',
            data:{
                id:id,
                appid:appid
