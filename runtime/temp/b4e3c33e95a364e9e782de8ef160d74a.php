...
<div class="content-wrapper" id="pjax-container" style="min-height: 706px;">
                    ...
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <div class="btn-group pull-right" style="margin-right: 10px">
                                ...
                                <a href="/merchant/orderlistbuy" class="btn btn-sm btn-facebook"><i class="fa fa-undo"></i>&nbsp;&nbsp;重置</a>
                            </div>
                            <div class="modal fade" id="filter-modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="/merchant/orderlistbuy" method="get" pjax-container="">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($vo['status'] == '0'): ?>
                                            <a id="<?php echo $vo['id']; ?>" class="btn btn-sm btn-danger biaoji">标记付款</a>
                                            <?php endif; ?>
    ...
    $('.biaoji').click(function() {
        layer.load(0, { shade: [0.5, '#8F8F8F'] });
        $.post("<?php echo url('home/merchant/uptradeinner'); ?>", { id: $(this).attr('id'), type: type }, function(data) {
            shelf = data.url;
    ...
    $('.shensu').click(function() {
        ...
        layer.prompt({
            ...
            if (val) {
                $.post("<?php echo url('home/merchant/shensu_ajax_trader'); ?>", { id: id, content: val }, function(data) {
                    if (data.code == 1) {
