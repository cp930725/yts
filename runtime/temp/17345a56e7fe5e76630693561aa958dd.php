...
<div class="box">
    ...
    <a href="/merchant/downapilog" class="btn btn-sm btn-facebook"><i class="fa fa-undo"></i>&nbsp;&nbsp;重置</a>
</div>
...
<div class="modal fade" id="filter-modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="/merchant/downapilog" method="get" pjax-container="">
...
<th>ID<a class="fa fa-fw fa-sort" href="/merchant/downapilog?order=asc"></a>
                            ...
                            <tr>
                            	...
                            	<td><?php echo $vo['api_name']; ?></td>
                            	<td><?php echo $vo['request_param']; ?></td>
                            	<td><?php echo $vo['return_param']; ?></td>
