<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"/www/wwwroot/abc.yptsc.cn/public/../application/admin/view/merchant/address.html";i:1563934900;s:67:"/www/wwwroot/abc.yptsc.cn/application/admin/view/public/header.html";i:1563934900;s:67:"/www/wwwroot/abc.yptsc.cn/application/admin/view/public/footer.html";i:1563934900;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                ...
                <!-- <div  class="col-sm-2" style="width: 100px">
                    ...
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('address'); ?>">
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <select name='addresstype' id='addresstype' class="form-control" style='float:left;'>
                                	<option>选择类型</option>
                                	<option value='1' <?php if($type == '1'): ?>selected<?php endif; ?>>商户用户</option>
                                	<option value='2' <?php if($type == '2'): ?>selected<?php endif; ?>>交易员</option>
                                </select>
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.getJSON('<?php echo url("Merchant/address"); ?>', {page: curr || 1,key:key,addresstype:type}, function(data){
