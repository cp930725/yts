...
<div class="content-wrapper" id="pjax-container" style="min-height: 706px;">
                    ...
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <div class="btn-group pull-right" style="margin-right: 10px">
                                ...
                                <a href="/merchant/orderlist" class="btn btn-sm btn-facebook"><i class="fa fa-undo"></i>&nbsp;&nbsp;重置</a>
                            </div>
                            <div class="modal fade" id="filter-modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="/merchant/orderlist" method="get" pjax-container="">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $vo['buy_username']; ?></td>
                                        <td><?php echo $vo['deal_amount']; ?></td>
                                        <td><?php echo $vo['deal_num']; ?></td>
                                        <td><?php echo $vo['deal_price']; ?></td>
                                        <td><?php echo date("Y-m-d H:i:s",$vo['ctime']); ?></td>
                                        <td>
                                            <?php if($vo['status'] == '0'): ?>待付款<?php endif; if($vo['status'] == '1'): ?>待放行<?php endif; if($vo['status'] == '4'): ?>已完成<?php endif; if($vo['status'] == '5'): ?>已关闭<?php endif; if($vo['status'] == '6'): ?>申诉中<?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if($vo['status'] == '1'): ?>
                                            <a id="<?php echo $vo['id']; ?>" class="btn btn-sm btn-danger shifang">放行</a>
                                            <?php endif; if($vo['status'] == '0'): ?>
                                            <a id="<?php echo $vo['id']; ?>" class="btn btn-sm btn-danger shifang2">放行</a>
                                            <?php endif; ?>
        ...
        layer.prompt({
            ...
            if (val) {
                ...
                $.post("<?php echo url('home/merchant/checkpaypass'); ?>", { paypassword: val }, function(respone) {
                    if (respone.code == 1) {
                        layer.close(val);
                        $.post("<?php echo url('home/merchant/sfbtc_ajax'); ?>", { id: id, type: type }, function(data) {
                            // console.log(id)
                            shelf = data.url;
    ...
    $('.shensu').click(function() {
        ...
        layer.prompt({
            ...
            if (val) {
                $.post("<?php echo url('home/merchant/shensu_ajax'); ?>", { id: id, content: val }, function(data) {
                    if (data.code == 1) {
