<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/www/wwwroot/abc.yptsc.cn/public/../application/admin/view/merchant/traderreward.html";i:1563934900;s:67:"/www/wwwroot/abc.yptsc.cn/application/admin/view/public/header.html";i:1563934900;s:67:"/www/wwwroot/abc.yptsc.cn/application/admin/view/public/footer.html";i:1563934900;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                ...
                <!-- <div  class="col-sm-2" style="width: 100px">
                    ...
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('traderreward'); ?>">
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" id="key" class="form-control" name="key" value="<?php echo $val; ?>" placeholder="输入需查询的交易员姓名/手机号" />   
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        $.getJSON('<?php echo url("Merchant/traderreward"); ?>', {page: curr || 1,key:key}, function(data){
