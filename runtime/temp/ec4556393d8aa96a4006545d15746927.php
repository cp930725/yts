<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/www/wwwroot/abc.yptsc.cn/public/../application/admin/view/merchant/withdrawlist.html";i:1563934900;s:67:"/www/wwwroot/abc.yptsc.cn/application/admin/view/public/header.html";i:1563934900;s:67:"/www/wwwroot/abc.yptsc.cn/application/admin/view/public/footer.html";i:1563934900;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                ...
                <!-- <div  class="col-sm-2" style="width: 100px">
                    ...
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('withdrawlist'); ?>">
                        <div class="col-sm-6">
                            <div class="input-group">
                                <input type="text" id="key" class="form-control" style="width:33%;" name="key" value="<?php echo $val; ?>" placeholder="输入需查询的商户姓名/手机号" />   
                                <input type="text" id="keyuser" class="form-control" style="width:33%;" name="keyuser" value="<?php echo $valuser; ?>" placeholder="输入需查询的用户名" />   
                                <select name="status" class="form-control" id="status" style="width:33%;">
                                	...
                                	<option value="1" <?php if($status == '1'): ?>selected<?php endif; ?>>待审核</option>
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.getJSON('<?php echo url("Merchant/withdrawlist"); ?>', {page: curr || 1,key:key, keyuser:keyuser, status:status}, function(data){
...
function pass(id){
	layer.confirm('请选择方式', {
		...
		$.post('<?php echo url("passWithdraw"); ?>', {id:id,type:1}, function(res){
			if(res.code == 1){
		...
		$.post('<?php echo url("passWithdraw"); ?>', {id:id,type:2}, function(res){
			if(res.code == 1){
                layer.msg(res.msg,{icon:1,time:1500,shade: 0.1});
                Ajaxpage();
            }else{
