...
.clear-image-padding{
    ...
    <div class="content-wrapper" id="pjax-container" style="min-height: 706px;">
    	 <div class="col-md-8">
            <h1 class="news-title"><?php echo $detail['title']; ?></h1>
            <!--搜索引擎，h1爬取权重较高-->
            <div class="new-info"><?php echo date("Y-m-d H:i:s", $detail['update_time']); ?>
                <div class="label label-default"><?php echo $detail['keyword']; ?></div>
            </div>
